...
class PatternModelMatching:    
    ...
    def __init__(self, eamsfile, annotatedfile, logfile, contextfile):
        ...
        :param file eamsfile: The name of the JSON file where EAMs are defined
        :param file annotatedfile: The name of the CSV file (CASAS format) where the patterns found by AD are
        :param file logfile:  The name of a text file generated as a log of the AD tool
        ...
        self.contextfile = contextfile      # TODO maybe we don't need this file
    ...
    def load_EAMs(self):
        ...
        # TODO extraer de la DB los datos necesarios para construir este dict.

        #### DAdo un usuario sacar todos sus EAMS y construir un JSON

        # Extraer los identificadores de los usuarios (unicos)
        # Por cada uno de ellos obtener la relacion --> EAM, Activity user_in_eam
    ...
    def load_annotated_data(self):
        ...
        # TODO GORKA REVISAR SI ESTO TIENE SENTIDO
    ...
    def process_patterns(self):
        ...
        actions = []
        # TODO GORKA revisar tema de sensores. ¿hacen falta?
        sensors = []
        pat = ""
        start = None
        end = None
...
#                if score > maxscore and len(actions) >= len(bestnames):
    ...
    def func_locations(self, sensors, eamindices):
        ...
        # TODO cambiar este for para extraer la localizacion de los LEA
